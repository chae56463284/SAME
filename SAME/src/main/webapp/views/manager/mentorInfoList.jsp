<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page
	import="java.util.List,com.kh.common.model.vo.PageInfo,com.kh.member.model.vo.Member, com.kh.common.model.vo.PageInfo"%>
<%!
    // 전화번호 포맷팅 함수
		...
		<div class="container">
			<div class="table">
				...
				<div class="table-row">
					...
					<div class="title">
						<a href="<%= request.getContextPath() %>/manager/memberDetail?mno=<%= m.getMemberNo() %>&type=mentor">
