...
<body>
  ...
  <div style="width: 1440px; height: 960px; position: relative; background: white">
    ...
    <!-- 사이드바끝 -->
    <!-- 페이지 제목 -->
    <div class="SameSame" style="width: 816px; height: 150px; left: 356px; top: -1px; position: absolute; color: #FF5C3D; font-size: 128px; font-family: Prompt; font-weight: 700; word-wrap: break-word">SAME SAME</div>
    
    <!-- 매니져 제목 -->
    <div class="Manager" style="width: 300px; height: 100px; left: 14px; top: 162px; position: absolute; color: #FF5C3D; font-size: 50px; font-family: Prompt; font-weight: 700; word-wrap: break-word">MANAGER</div>
