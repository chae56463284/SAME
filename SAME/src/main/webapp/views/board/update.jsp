...
<%@ page import="java.util.List, com.kh.board.model.vo.*, com.kh.board.model.dto.BoardDTO" %>
<!DOCTYPE html>
<%
...
<body>
	<div class="main">
		...
		<div class="container">
			...
			<div class="detail-container">
				...
				<div class="detail-header">
					...
					<h1 class="detail-title"><%=b.getBoardTitle() %></h1>
					<div>
				...
				<hr>
				<!-- 작성 내용 -->
				<div class="detail-content"><%=b.getBoardContent() %></div>
        ...
        <input type="file" name="upfile">
             ...
             <!--  수정하기 버튼 -->
             <div align="center">
                <input type="submit" value="수정하기" class="btn btn-secondary btn-sm">
            </div>
	</div>
