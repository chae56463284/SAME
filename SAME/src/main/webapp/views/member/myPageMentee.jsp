...
<body>
	<%@ include file="/views/common/mainHeader.jsp" %>
	  <div class="container">
              ...
              <a href="회원정보수정.html" class="text-red" style="text-decoration: none;">회원정보 수정</a>
              </div>
              <input type="text" class="input-box" style="top: 21px;" placeholder="아이디" />
              <input type="text" class="input-box" style="top: 99px;" placeholder="이름" />
              <input type="text" class="input-box" style="top: 185px;" placeholder="이메일" />
        ...
        <div class="purchase-section">
            ...
            <img class="user-icon" src="https://via.placeholder.com/48x48" alt="User Icon" />
